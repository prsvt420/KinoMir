...
class Serial(models.Model):
    ...
    season_count: models.PositiveIntegerField = models.PositiveIntegerField(
        verbose_name="Количество сезонов"
    )
    country: models.CharField = models.CharField(max_length=255, verbose_name="Страна")
    age_limit: models.PositiveIntegerField = models.PositiveIntegerField(
...
class SerialParticipant(models.Model):
    ...
    role: models.CharField = models.CharField(
        max_length=50, choices=RoleChoices.choices, verbose_name="Роль"
    )
